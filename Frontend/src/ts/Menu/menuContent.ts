...
function getrequestJoinTournamentBtn(): HTMLButtonElement {
	...
	btn.addEventListener('click', requestJoinTournament);
	return btn;
}
...
export function getMenu() {
	...
	bottomButtonDiv.appendChild(getrequestJoinTournamentBtn());
